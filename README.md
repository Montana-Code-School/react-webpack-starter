#Starter Kit for [Building Applications in React with Webpack](http://github.com/Montana-Code-School/react-webpack-starter)
Inspired by [https://github.com/coryhouse/pluralsight-redux-starter]

## Get Started
1. **Install [Node 6](https://nodejs.org)**. Need to run multiple versions of Node? Use [nvm](https://github.com/creationix/nvm) or [nvm-windows](https://github.com/coreybutler/nvm-windows)
2. **Clone this repository.** - `git clone http://github.com/Montana-Code-School/react-webpack-starter.git`
3. **Make sure you're in the directory you just created.** - `cd react-webpack-starter`
